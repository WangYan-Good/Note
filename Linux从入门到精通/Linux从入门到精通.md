...
除了以上所提到的几款，还有一些其他的浏览器可以在Linux平台中运行，包括 Konqueror、Galeon、Epiphany 和 Songbird 等。
...
#### 13.1.2 邮件协议：浏览器还是邮件客户端

POP3、IMAP、SMTP协议

### 13.2 Gnome下的邮件客户端：Evolution

### 13.3 KDE下的邮件客户端：Kmail

### 13.4 小结

## 第十四章 传输文件

### 14.1 Linux间的网络硬盘：NFS

#### 14.1.1 安装NFS文件系统

使用 mount 命令安装 NFS 文件系统，命令如下：
